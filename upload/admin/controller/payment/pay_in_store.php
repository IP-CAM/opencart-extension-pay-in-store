<?php
class ControllerPaymentPayInStore extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('payment/pay_in_store');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/pay_in_store', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('payment/pay_in_store', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('payment/pay_in_store.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'payment/pay_in_store')) {
